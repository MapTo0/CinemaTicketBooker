...
public class User implements Serializable {
    ...
    @OneToMany
    private Set<Projection> currentProjections = new HashSet<Projection>();
    ...
    public void setCurrentProjections(final Set<Projection> currentProjection) {
        this.currentProjections = currentProjection;
    }
